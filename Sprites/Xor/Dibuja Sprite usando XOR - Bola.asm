...
; DE = direccion del sprite (80 bytes, 5 por linea)
; Se asume sprite de 16 líneas y 5 bytes por linea (modo 0)
...
draw_sprite_xor_mode0:
    ...
    ld ixl,16		    ; 16 lineas del sprite
draw_sprite_line:       ; pinta linea
    ...
    add hl,bc
no_wrap:
    dec ixl	        	; -1 contador de lineas, dec IXL afecta flag Z y crea condicion de salida
    jr nz,draw_sprite_line
    backup_sp : ld sp,0
    ei
    ret
